...
sudo -u postgres psql omusic_db -c "CREATE TABLE users (id bigserial primary key, created_at timestamp not null default current_timestamp, username char(20) not null, password char(20) not null, admin boolean)"
