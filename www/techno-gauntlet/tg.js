...
tg.getSong = function (callback) {
    ...
    if (!id) {
        ...
        var defaultSong = {"name":"","type":"SONG","sections":[{"type":"SECTION","parts":[{"type":"PART","notes":[],"surface":{"url":"PRESET_VERTICAL"},"soundSet":{"url":"PRESET_OSC_SINE","name":"Sine Oscillator","type":"SOUNDSET","octave":5,"lowNote":0,"highNote":108,"chromatic":true},"audioParameters":{"pan":0,"warp":1,"volume":0.6}}],"chordProgression":[0]}],"keyParameters":{"scale":[0,2,4,5,7,9,11],"rootNote":0},"beatParameters":{"bpm":120,"beats":4,"shuffle":0,"measures":1,"subbeats":4,"subbeatMillis":125}}
