...
OMGAudioFX.prototype.makeFXNode = function (fxName, fxData) {
    ...
    return {name: fxName, data: fxData, controls: fxInfo.controls, node: fxNode};
};


OMGAudioFX.prototype.setupFX = function () {
    var p = this;
...
OMGAudioFX.prototype.makeEQ = function (data) {
    var p = this;
...
OMGAudioFX.prototype.makeDelay = function (data) {
    var p = this;
    var input = p.context.createGain();
...
OMGAudioFX.prototype.makeRadPad = function (data) {
    var p = this;
    var input = p.context.createGain();
    var output = p.context.createGain();
    input.connect(output);
